 ...
 */ 
public class ServeurIHM_11 extends javax.swing.JFrame {
   ...
   public int port ;
      ...
      ecritureAffichage("Configuration de la source (webcam)");
        ...
        try {
            ...
            WebcamCessor = Manager.createProcessor(videoLocator);
              ...
              Logger.getLogger(ServeurIHM_11.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServeurIHM_11().setVisible(true);
