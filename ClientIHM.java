 ...
 * @author BENAMAR
 */
public class ClientIHM extends javax.swing.JFrame {
  //  MotionDetectionEffect mdd = MotionDetectionEffect();
    ...
    public URL fileurl;
 public Player p , fileplayer ;
 public Processor processor ;
   
    Image Img1, Img2 ;
    Component videoScreen , localvideo ;
      ...
      if (ipsrv1.getText().length()== 0 ||
         ...
         ecritureAffichage("En attente du flux video ... ");
          ...
          try {
              ...
              //Initialize the RTPManager using the local sessionaddress
                    ...
                    //new flux received 
                      ...
                      try {
                       ...
                       //
                            ...
                            videoScreen.setSize(f.fluxpanel.getSize());
                               f.fluxpanel.removeAll();
                               f.fluxpanel.add(videoScreen,BorderLayout.CENTER);
                               f.fluxpanel.repaint();
                               f.fluxpanel.revalidate();
